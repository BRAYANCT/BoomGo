...
use App\Department;
use App\Http\Resources\Admin\DepartmentAdminResource;
use App\Services\DepartmentServiceImpl;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class DepartmentApiAdminController extends Controller
{
    private $service;
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            $list = DepartmentAdminResource::collection($this-> service-> findAllWhere($parameters,$relationshipNames));
