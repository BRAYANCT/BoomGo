...
use App\Http\Resources\Admin\ProvinceAdminResource;
use App\Province;
use App\Services\ProvinceServiceImpl;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class ProvinceApiAdminController extends Controller
{
    private $service;
    ...
    public function index(Request $request)
    {
        ...
        try{
            ...
            $list = ProvinceAdminResource::collection($this-> service-> findAllWhere($parameters,$relationshipNames));
