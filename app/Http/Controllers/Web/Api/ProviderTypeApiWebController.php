...
use App\Http\Resources\Web\ProviderTypeWebResource;
use App\ProviderType;
use App\Services\ProviderTypeServiceImpl;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;

class ProviderTypeApiWebController extends Controller
{
    ...
    public function index()
    {
        ...
        try{
            ...
            $list = ProviderTypeWebResource::collection($this->service->findAllWhere([]));
