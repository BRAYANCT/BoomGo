...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
	...
	return function(t, e, i, n) {
		...
		function s(t, e) {
			var i = t;
			return f.isString(t) ? v.Easings[t] || (i = !1) : i = f.isArray(t) && 1 === t.length ?
			function(t) {
				return function(e) {
				...
				for (var o = 0; i > o; o++) if (v.State.calls[o]) {
					...
					for (var g = Math.min((e - h) / d.duration, 1), y = 0, x = s.length; x > y; y++) {
						...
						if (a(C)) {
							...
							for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), k) if ("element" !== T) {
								var M, I = k[T],
		...
		function c(t, e) {
			...
			v.State.calls[t] = !1;
			for (var p = 0, m = v.State.calls.length; m > p; p++) if (!1 !== v.State.calls[p]) {
				l = !0;
				break
			...
			var x = function() {
				...
				if (f.isWrapped(this) ? (d = !1, p = 0, g = this, h = this) : (d = !0, p = 1, g = k ? arguments[0].elements || arguments[0].e : arguments[0]), g = o(g)) {
					...
					if (u.each(g, function(t, e) {
						f.isNode(e) && r.call(e)
					}), (O = u.extend({}, v.defaults, w)).loop = parseInt(O.loop), E = 2 * O.loop - 1, O.loop) for (var R = 0; E > R; R++) {
						var W = {
							delay: O.delay,
							progress: O.progress
						};
	...
	return function t(e, i, n) {
				...
				t.controllers.bar = t.DatasetController.extend({
					...
					calculateBarValuePixels: function(t, e) {
						var i, n, o, a, r, s, l = this.chart,
							...
							p = c.stack,
							m = 0;
						if (f || void 0 === f && void 0 !== p) for (i = 0; i < t; ++i)(n = l.getDatasetMeta(i)).bar && n.stack === p && n.controller.getValueScaleId() === u.id && l.isDatasetVisible(i) && (o = u.getRightValue(d[i].data[e]), (h < 0 && o < 0 || h >= 0 && o > 0) && (m += o));
			...
			o.extend(a.prototype, {
				...
				transition: function(t) {
					...
					return i && 1 !== t ? (a || (a = e._view = {}), o || (o = e._start = {}), function(t, e, i, o) {
						...
						for (a = 0, r = p.length; a < r; ++a) if (u = i[s = p[a]], e.hasOwnProperty(s) || (e[s] = u), (l = e[s]) !== u && "_" !== s[0]) {
		...
		27: [function(t, e, i) {
			...
			e.exports = function(t) {
				...
				}, a.requestAnimFrame = "undefined" == typeof window ?
				function(t) {
					t()
						...
						if (o.display) {
							...
							if (a.each(g, function(i, n) {
								...
								if (h.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), u.display) {
									...
									var e = t.label;
									if (a.isArray(e)) for (var i = 0, n = 0; i < e.length; ++i) s.fillText("" + e[i], 0, n), n += 1.5 * y.size;
			...
			e.exports = {
				...
				acquireContext: function(t, e) {
					...
					return i && i.canvas === t ? (function(t, e) {
						...
						if (null === n || "" === n) if ("" === t.style.height) t.height = t.width / (e.options.aspectRatio || 2);
						else {
							var s = u(t, "height");
							void 0 !== r && (t.height = s)
						}
			...
			n._set("global", {
				...
				return t.Legend = o.extend({
					...
					fit: function() {
						...
						if (g ? (m.width = t.maxWidth, m.height = o ? 10 : 0) : (m.width = o ? 10 : 0, m.height = t.maxHeight), o) if (s.font = f, g) {
						...
						if (e.display) {
							...
							a.each(t.legendItems, function(n, r) {
								var f = d.measureText(n.text).width,
									...
									g = u.x,
									v = u.y;
								x ? g + m >= l && (v = u.y += w, u.line++, g = u.x = t.left + (l - c[u.line]) / 2) : v + w > t.bottom && (g = u.x = g + t.columnWidths[u.line] + i.padding, v = u.y = t.top + i.padding, u.line++), function(t, i, n) {
									if (!(isNaN(y) || y <= 0)) {
								...
								}(g, v, n), b[r].left = g, b[r].top = v, function(t, e, i, n) {
									var o = p / 2,
										a = y + o + t,
										r = e + o;
				...
				return t.Title = o.extend({
					...
					draw: function() {
						...
						if (o.display) {
							...
							var w = o.text;
							if (a.isArray(w)) for (var k = 0, C = 0; C < w.length; ++C) e.fillText(w[C], 0, k, s), k += p;
			...
			e.exports = function(t) {
				var e = t.Scale.extend({
					...
					determineDataLimits: function() {
						...
						for (t = 0, i = (f.data.datasets || []).length; t < i; ++t) if (f.isDatasetVisible(t)) if (l = f.data.datasets[t].data, a.isObject(l[0])) for (b[t] = [], e = 0, o = l.length; e < o; ++e) c = p(l[e], h), y.push(c), b[t][e] = c;
					...
					buildTicks: function() {
						...
						return o.min = a, o.max = r, o._unit = u.unit ||
						function(t, e, i, o) {
	...
	t(["jquery"], function(t) {
		return function() {
			...
			function u(i) {
				...
				if (void 0 !== i.optionsOverride && (a = t.extend(a, i.optionsOverride), r = i.optionsOverride.iconClass || r), !
				function(t, e) {
	...
	t.fn.scrollTo = function(e) {
		...
		this.each(function() {
			...
			function l(e) {
				...
				if (!g.is("body") && g[0].scrollHeight > g[0].clientHeight && (m = g[0].scrollTop), c + r.innerWidth() > t(window).width() ? d = "right" : c - r.innerWidth() + n.innerWidth() < 0 && (d = "left"), u + r.innerHeight() > i) if (u + l - r.innerHeight() < 0) {
					var v = i - u - p;
					r.css("max-height", v)
...
dropdownSelectors.on({
	...
	t(".fixed-action-btn").on({
		click: function(e) {
			return e.preventDefault(), function(e) {
	...
	function G(t, e, i) {
		...
		i.isFirst = !! r, i.isFinal = !! s, r && (t.session = {}), i.eventType = e, function(t, e) {
			...
			e.overallVelocityX = h.x, e.overallVelocityY = h.y, e.overallVelocity = c(h.x) > c(h.y) ? h.x : h.y, e.scale = s ? (f = s.pointers, p = o, it(p[0], p[1], Q) / it(f[0], f[1], Q)) : 1, e.rotation = s ?
			function(t, e) {
			...
			var e = vt[t.type],
				i = function(t, e) {
					...
					if (a = i.filter(function(t) {
						return C(t.target, l)
					}), e === R) for (o = 0; o < a.length;) n[a[o].identifier] = !0, o++;
					o = 0;
...
function(t) {
	...
	var e = function(t, e) {
		...
		e.scaleColor && e.scaleLength && (r -= e.scaleLength + 2), Date.now = Date.now ||
		function() {
			return +new Date
		};
		...
		var s = function(t, e, i) {
			...
			l = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame ||
			function(t) {
	...
	t.fn.easyPieChart = function(i) {
		return this.each(function() {
			var n;
			t.data(this, "easyPieChart") || (n = t.extend({}, i, t(this).data()), t.data(this, "easyPieChart", new
			function(t, i) {
				var n = {
					barColor: "#ef1e25",
					trackColor: "#f9f9f9",
			...
			if (!n.hasClass("browser-default")) {
				...
				if (a && (n.parent().find("span.caret").remove(), n.parent().find("input").remove(), n.unwrap(), t("ul#select-options-" + a).remove()), "destroy" !== e) {
					...
					C.on("keydown", function(e) {
						if (9 != e.which) if (40 != e.which || d.is(":visible")) {
	...
	function a(e, l, u, d) {
		...
		var h = !1,
			...
			y = v.prototype = {
				...
				$node: g,
				start: function() {
					return f && f.start ? y : (f.methods = {}, f.start = !0, f.open = !1, f.type = e.type, e.autofocus = e == c(), e.readOnly = !p.editable, e.id = e.id || f.id, "text" != e.type && (e.type = "text"), y.component = new u(y, p), y.$root = t('<div class="' + m.picker + '" id="' + e.id + '_root" />'), s(y.$root[0], "hidden", !0), y.$holder = t(b()).appendTo(y.$root), x(), p.formatSubmit &&
					function() {
						var i;
				...
				on: function(e, i, n) {
					...
					if (e) for (o in r || (s[e] = i), s) a = s[o], n && (o = "_" + o), f.methods[o] = f.methods[o] || [], f.methods[o].push(a);
					return y
				},
	...
	o.prototype.set = function(t, e, i) {
		...
		if ((!o || !o.nav && !o.defaultValue) && (!h && c.disabled(i) || h && c.disabled(i) && (m || a || r) || !h && (i.pick <= f.pick || i.pick >= p.pick))) for (h && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= f.pick ? (s = !0, d = 1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : -1)])) : i.pick >= p.pick && (l = !0, d = -1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : 1)])), !s || !l);) i = c.create([i.year, i.month, i.date + d]);
		return i
	...
	function S(t, e) {
		...
		if (e.twelvehour) for (E = 0; E < 12; E += e.hourstep) O = R.clone(), L = E / 6 * Math.PI, F = y, O.css("font-size", "140%"), O.css({
		...
		for (E = 0; E < 60; E += H) for (E = 0; E < 60; E += 5) O = R.clone(), L = E / 30 * Math.PI, O.css({
	...
	S.DEFAULTS = {
		...
		var t = this.input.prop("value") || this.options.
	default || "";
	...
	return function(t, e, i, n) {
		...
		var s, l, c, u, d, h, f, p, m, g, v, y, b, x, w, k, C, S, T, M, I, P, A, D, _, E, O, L, F, R, W, H, N, z, V, B, j, Y, $, X, q, U, Q, Z, G, K, J, tt, et, it, nt, ot, at, rt, st, lt = {
			...
			Pe = function() {
				if (Z) {
					var t = Z.length;
					if (0 !== t) if (Ot(Gt, Z[0]), Jt.x = Gt.x - te.x, Jt.y = Gt.y - te.y, G && t > 1) {
						if (te.x = Gt.x, te.y = Gt.y, !Jt.x && !Jt.y &&
						function(t, e) {
			...
			Ae = function(t) {
				...
				var c = -1;
				if (0 === l && (Y = !1, o.unbind(window, f, a), fe(), G ? c = 0 : -1 !== le && (c = Tt() - le)), le = 1 === l ? Tt() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", G && 2 > l && (G = !1, 1 === l && (n = "zoomPointerUp"), St("zoomGestureEnded")), Z = null, q || X || et || B) if (Ut(), z || (z = De()), z.calculateSwipeSpeed("x"), B) if (xe() < r.verticalDragRange) a.close();
				else {
					var u = ut.y,
						d = at;
		...
		var ei, ii, ni, oi, ai, ri, si, li, ci, ui, di, hi, fi = {
			...
			gi = function() {
				...
				if (r.galleryPIDs) {
					var a = e.pid;
					for (e.pid = 0, i = 0; i < Re.length; i++) if (Re[i].pid === a) {
						e.pid = i;
						break
					}
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function(t) {
		...
		function n(t, e) {
			function i(i) {
				...
				(function(e, i) {
					...
					return !1
				})(s, l) || (n = !1, e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (r(t, "top", l ? t.scrollTop - l * e.settings.wheelSpeed : t.scrollTop + s * e.settings.wheelSpeed), n = !0) : e.scrollbarXActive && !e.scrollbarYActive && (r(t, "left", s ? t.scrollLeft + s * e.settings.wheelSpeed : t.scrollLeft - l * e.settings.wheelSpeed), n = !0) : (r(t, "top", t.scrollTop - l * e.settings.wheelSpeed), r(t, "left", t.scrollLeft + s * e.settings.wheelSpeed)), a(t), (n = n ||
				function(i, n) {
					var o = t.scrollTop;
					if (0 === i) {
						if (!e.scrollbarYActive) return !1;
	...
	m.prototype.css = function(e, i) {
		...
		for (var t = 0, e = p.length; t < e; t++) if (p[t].instanceID === this.instanceID) {
			p.splice(t, 1);
			break
		}
	...
	var y = function(t) {
		...
		for (var e, i = arguments[1], n = Array.prototype.slice.call(arguments, 2), o = t.length, a = 0; a < o; a++) if ("object" == typeof i || void 0 === i ? t[a].jarallax || (t[a].jarallax = new m(t[a], i)) : t[a].jarallax && (e = t[a].jarallax[i].apply(t[a].jarallax, n)), void 0 !== e) return e;
		return t
	};
	...
	n.prototype.parseURL = function(t) {
		...
		if (this.userEventsList && this.userEventsList[t]) if (e) for (var i = 0; i < this.userEventsList[t].length; i++) this.userEventsList[t][i] === e && (this.userEventsList[t][i] = !1);
		...
		n.$iframe ? e(n.$iframe) : n.onAPIready(function() {
			...
			if ("local" === n.type) {
				if (!n.$iframe) for (var p in n.$iframe = document.createElement("video"), n.options.mute && (n.$iframe.muted = !0), n.options.loop && (n.$iframe.loop = !0), n.$iframe.setAttribute("id", n.playerID), o.appendChild(n.$iframe), document.body.appendChild(o), n.videoID) r = n.$iframe, s = n.videoID[p], l = "video/" + p, c = void 0, (c = document.createElement("source")).src = s, c.type = l, r.appendChild(c);
				var m;
	...
	n.prototype.onAPIready = function(e) {
		...
		})), "vimeo" === this.type) if ("undefined" != typeof Vimeo || s)"undefined" != typeof Vimeo ? e() : c.done(function() {
			e()
		});
		else {
			s = 1;
	...
	return t = $.extend({
		...
		Object.keys(n).length && (i = $('<ul class="mdb-autocomplete-wrap"></ul>')).insertAfter($(this)), e.on("keyup", function(t) {
			...
			if (i.empty(), o.length) for (var a in n) if (-1 !== n[a].toLowerCase().indexOf(o.toLowerCase())) {
				var r = $("<li>" + n[a] + "</li>");
				i.append(r)
			}
