    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <a 	href="{{ route($prefixRouteWeb.'category_type_slug.create',$categoryType->slug) }}"
    ...
    <script type="text/javascript">
        ...
        let inicializar = function (){
            ...
            tablaListado = $('#tabla-listado').DataTable( {
                ...
                "ajax":"{{ route($prefixRouteApi.'category_type.list_table.index',$categoryType)}}",
                "columns": [
                    { "data": "checkbox" }, // envia el id para luego armar el check
                    { "data": "name" },
                    { "data": "parent_name" },
                    { "data": "display_created_at" ,"type": "date-eu"},
                    { "data": "actions" },
                ],
                "responsive":false,
                "scrollX": true,
